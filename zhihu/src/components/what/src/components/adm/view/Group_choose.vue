      ...
      >
        ...
        <el-table-column prop="done" label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" plain @click="jStudent(scope.row.id)">学生管理</el-button>
            <el-button size="mini" type="primary" plain @click="jTeacher(scope.row.id)">教师管理</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
