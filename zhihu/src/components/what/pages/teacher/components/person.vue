<template>
  <div class="personal">
    ...
    <ul class="nav">
        <li class="amend">
            <el-button :plain="true" type="primary" @click="goto()">编辑信息</el-button>
        </li>
    </ul>
    ...
    <div class="personal-form">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="学历" placeholder="请输入学历">{{form.education}}</el-form-item>
        <el-form-item label="研究方向">{{form.specialty}}</el-form-item>
      </el-form>
    </div>
    ...
    <div class="description">
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="简历" placeholder="请输入内容" class="newdes">
          ...
          <div v-html="form.description" style="cursor:default"></div>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  methods: {
    ...
    goto() {
      this.$router.push({ name: "showpersonal" });
    }
  },
  created() {
    this.$axios({
