<template>
  <div class="student-list">
    <div class="student-list-title">
      ...
      <span class="student-list-title-text">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>额外轮</el-breadcrumb-item>
    ...
    <div class="reminder">
      <p class="present">当前轮次:{{this.round==4 ? "额外轮":this.round}}</p>
      <p class="number">已选人数:{{this.now1}}</p>
      <p class="most">最高人数:{{this.limit-this.now}}</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    load() {
      ...
      setTimeout(() => {
        this.page += 1; //页数+1
        this.getmessage(); //调用接口，此时页数+1，查询下一页数
      }, 2000);
    },
    getmessage() {
