<template>
  <div>
    ...
    >
      ...
      <el-menu-item index="2" class="pc">互选情况</el-menu-item>
    ...
    <div class="content-mobile" v-bind:class="{is_display: display_mobile}">
      ...
      >
        ...
        <el-menu-item index="2" class="mob"><span class="mob-text">互选情况</span></el-menu-item>
...
export default {
  ...
  methods: {
    ...
    goto_change_password(){
      this.$router.push("/teacher_change_password");
    },
    is_display_mobile(){
